...
def fetch_pytorch_repos(token=None, max_repos=10, min_stars=50):
    ...
    # Search for Python repos with pytorch in name or description
    query = f"pytorch language:Python stars:>={min_stars}"
    ...
    print(f"Searching GitHub for Pytorch repos (>={min_stars} stars)...")
